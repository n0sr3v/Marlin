...
#define Z_PROBE_OFFSET_FROM_EXTRUDER -1.6   // Z offset: -below +above  [the nozzle] (prev: -2.2 modified 14.02.20)
...
#define INVERT_E0_DIR true // default false - had to change this (because of turned extruder)
